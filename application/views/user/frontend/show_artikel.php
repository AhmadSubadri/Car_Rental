...
<section class="ftco-section">
    <div class="container px-4">
        <?php $id = $hasil->id_artikel;?>
        <div class="row">
            <div class="col-sm-4">
                <img src="<?php echo base_url()?>./upload/artikel/<?php echo $hasil->foto ?>" style="max-width: 100%;">
            </div>
            <div class="col-sm-8">
                <p class="blockquote-footer">Update <?php echo $hasil->tgl;?></p>
...
<!-- artikel lainya -->
    ...
    <h2>Artikel Lainya</h2>
        ...
        return implode(" ",array_splice($words,10,$word_limit)); } foreach ($var as $i) :
        $id = $i['id_artikel'];
        $judul=$i['Title'];
        $isi=$i['Deskripsi'];
        $image=$i['foto'];
